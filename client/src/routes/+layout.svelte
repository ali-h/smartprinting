<script>
	...
	import {AppBar, initializeStores, Drawer, getDrawerStore, Toast, ProgressBar } from '@skeletonlabs/skeleton';
	...
	const openDrawer = () => {
		const settings = {
			...
			bgBackdrop: 'variant-glass-secondary',
			width: 'w-3/4 md:w-[350px]',
		}
	...
	<Drawer>
		<div class="flex flex-col w-full">
			<div class="p-4 flex justify-between items-center">
				{#if $isLoggedIn}
				<a class="btn variant-ghost-secondary ps-0 py-0" href="/profile">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-9 h-9 text-gray-300 bi bi-person-circle" viewBox="0 0 16 16">
			...
			<div class="flex mt-5 flex-col gap-2">
				{#if $isLoggedIn}
				<a class="btn variant-glass-secondary btn-lg rounded-l-none rounded-r-full w-4/5" href="/">
				...
				<a class="btn variant-glass-secondary btn-lg rounded-l-none rounded-r-full w-4/5" href="/topup">
				...
				<a class="btn variant-glass-secondary btn-lg rounded-l-none rounded-r-full w-4/5" href="/settings">
				...
				{/if}
				<a class="btn variant-glass-secondary btn-lg rounded-l-none rounded-r-full w-4/5" href="/guide">
				...
				{#if !$isLoggedIn}
				<a class="btn variant-glass-secondary btn-lg rounded-l-none rounded-r-full w-4/5" href="/login">
				...
				<a class="btn variant-glass-secondary btn-lg rounded-l-none rounded-r-full w-4/5" href="/register">
				...
				{:else}
				<button class="btn variant-glass-error btn-lg rounded-l-none rounded-r-full w-4/5" on:click={logout}>
			...
			<div class="absolute bottom-4 right-0 flex flex-col gap-2">
				<a class="btn variant-glass-error btn-lg rounded-r-none rounded-l-full" href="/about">
				...
				<a class="btn variant-glass-error btn-lg rounded-r-none rounded-l-full" href="/report">
